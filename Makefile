#############################################################################
# Makefile for building: output/gdrum
# Generated by qmake (3.1) (Qt 5.15.10)
# Project:  gdrum.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile gdrum.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = gdrum1.0.0
DISTDIR = /home/pi/Documents/gdrum/output/obj/gdrum1.0.0
LINK          = g++
...
output/gdrum:  $(OBJECTS)  
	@test -d output/ || mkdir -p output/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: gdrum.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
output/rcc/qrc_qml.cpp: qml.qrc \
		/usr/lib/qt5/bin/rcc \
		src/gui/main.qml \
		src/gui/components/SignalChannel.qml \
		src/gui/components/ButtonMenu.qml \
		src/gui/components/SliderChannel.qml \
		src/gui/components/ChannelSample.qml \
		src/gui/components/WaveContainer.qml \
		src/gui/components/TitleBar.qml \
		src/gui/components/ButtonIcon.qml \
		src/gui/pages/MainScreen.qml \
		src/gui/pages/SplashScreen.qml \
		resources/images/background.png \
		resources/images/logo_gdrum.png \
