...
#include <memory>
#include "../../include/sensors/Worker.h"
...
QT_MOC_LITERAL(5, 27, 17), // "thresholdExceeded"
QT_MOC_LITERAL(6, 45, 7), // "channel"
QT_MOC_LITERAL(7, 53, 7), // "process"
QT_MOC_LITERAL(8, 61, 4) // "stop"

    },
    "Worker\0finished\0\0error\0err\0thresholdExceeded\0"
    "channel\0process\0stop"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::thresholdExceeded)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Worker::thresholdExceeded(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
